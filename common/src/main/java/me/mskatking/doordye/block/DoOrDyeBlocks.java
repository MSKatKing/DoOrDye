...
public class DoOrDyeBlocks {
    ...
    public static final Block CALLA_LILLY = CommonBlocks.register("calla_lilly", prop -> new FlowerBlock(SuspiciousStewEffects.EMPTY, prop), BlockBehaviour.Properties.of(), true);
